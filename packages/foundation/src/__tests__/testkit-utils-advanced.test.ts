...
describe('Testkit Advanced Utils', () => {
  describe('Testing Utilities', () => {
    ...
    it('should handle controlled promise rejection', async () => {
      ...
      const { promise, reject } = TestingUtils.createControlledPromise<string>()
  ...
  describe('Concurrency Management', () => {
    ...
    it('should use ConcurrencyManager.drain to wait for completion', async () => {
      ...
      // Start multiple operations (don't await them individually)
      ...
      // eslint-disable-next-line sonarjs/no-misleading-array-reverse -- Test intentionally sorts in place for performance comparison
    ...
    it('should provide limitedAllSettled function', async () => {
      ...
      const tasks = [() => Promise.resolve(1), () => Promise.reject(new Error('failed')), () => Promise.resolve(3)]
  ...
  describe('Object Pooling', () => {
    it('should export object pool types', async () => {
      const { ObjectPool, ArrayPool, BufferPool, PromisePool, poolManager } = await import('@orchestr8/testkit/utils')
  ...
  describe('Resource Management', () => {
    it('should export resource manager', async () => {
      const { ResourceManager, globalResourceManager, registerResource, cleanupAllResources } = await import(
  ...
  describe('Integration Tests', () => {
    ...
    it('should manage pooled resources efficiently', async () => {
      ...
      const buffers = Array.from({ length: 5 }, () => TestingUtils.createTestBuffer(256))
    ...
    it('should detect and prevent resource leaks', async () => {
      const { registerResource, detectResourceLeaks, cleanupAllResources } = await import('@orchestr8/testkit/utils')
