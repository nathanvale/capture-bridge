...
describe('SQLite Connection Pool', () => {
  ...
  describe('Pool Creation and Configuration', () => {
    ...
    it('should throw error for invalid maxConnections', async () => {
      ...
      expect(() => {
        // eslint-disable-next-line sonarjs/constructor-for-side-effects -- testing error throwing
  ...
  describe('Connection Acquisition and Release', () => {
    ...
    it('should warn when releasing unknown connection', async () => {
      ...
      expect(consoleWarnSpy).toHaveBeenCalledWith('Attempted to release unknown connection to pool')
    ...
    it('should warn when releasing connection twice', async () => {
      ...
      expect(consoleWarnSpy).toHaveBeenCalledWith('Attempted to release connection that was not in use')
  ...
  describe('Pool Shutdown', () => {
    ...
    it('should prevent new acquisitions after shutdown', async () => {
      ...
      await expect(pool.acquire()).rejects.toThrow('Cannot acquire connection from shutting down pool')
    })
  ...
  describe('Concurrent Operations', () => {
    it('should handle concurrent acquisitions', async () => {
      ...
      const acquisitions = Array.from({ length: 10 }, () =>
        // eslint-disable-next-line sonarjs/no-nested-functions -- concurrent operations test requires nested async functions
