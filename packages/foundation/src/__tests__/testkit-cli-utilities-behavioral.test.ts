/* eslint-disable no-console, vitest/expect-expect, sonarjs/assertions-in-tests */
 ...
 *
 * NOTE: Many tests in this file are intentional smoke/behavioral tests that
 * verify "no throw" behavior. The test passing IS the assertion. ESLint rules
 * for expect-expect and sonarjs/assertions-in-tests are disabled for this file.
 *
 * Tests cover:
...
describe('CLI Utilities - Behavioral Tests', () => {
  ...
  describe('Process Failure Scenarios', () => {
    it('should mock process failures with non-zero exit codes', async () => {
      ...
      builder.stderr('Unknown argument: --invalid-flag').exitCode(1).mock()
    ...
    // eslint-disable-next-line vitest/expect-expect, sonarjs/assertions-in-tests -- Behavioral test validates mock setup
    it('should handle command not found errors', async () => {
      const { mockSpawn } = await import('@orchestr8/testkit/cli')

      // Mock command not found
      mockSpawn('nonexistent-command').stderr('command not found: nonexistent-command').exitCode(127).mock()
    ...
    it('should handle permission denied errors', async () => {
      ...
      mockSpawn('restricted-script.sh').stderr('Permission denied').exitCode(126).mock()
  ...
  describe('Process Output Streaming', () => {
    it('should capture stdout output', async () => {
      ...
      mockSpawn('echo "Hello World"').stdout('Hello World\n').exitCode(0).mock()
    ...
    it('should capture stderr output', async () => {
      ...
      mockSpawn('error-command').stderr('This is an error message\n').exitCode(1).mock()
    ...
    it('should handle both stdout and stderr simultaneously', async () => {
      ...
      mockSpawn('mixed-output').stdout('Normal output\n').stderr('Warning message\n').exitCode(0).mock()
...
Line 4`
      ...
      mockSpawn('multiline-command').stdout(multilineOutput).exitCode(0).mock()
  ...
  describe('Exit Code Validation', () => {
    it('should validate success exit code (0)', async () => {
      ...
      mockSpawn('success-command').stdout('Success').exitCode(0).mock()
    ...
    it('should validate general error exit code (1)', async () => {
      ...
      mockSpawn('error-command').stderr('General error').exitCode(1).mock()
    ...
    it('should validate command not found exit code (127)', async () => {
      ...
      mockSpawn('not-found').stderr('command not found').exitCode(127).mock()
    ...
    it('should validate custom exit codes', async () => {
      ...
      // Custom exit code
      mockSpawn('custom-exit').stderr('Custom error').exitCode(42).mock()
  ...
  describe('SpawnMockBuilder Chaining', () => {
    ...
    it('should allow multiple stdout calls', async () => {
      ...
      mockSpawn('multi-stdout').stdout('First output\n').stdout('Second output\n').exitCode(0).mock()
    ...
    it('should allow builder pattern with only exitCode', async () => {
      ...
      mockSpawn('silent-command').exitCode(0).mock()
  ...
  describe('CommonCommands Git Operations', () => {
    ...
    it('should create custom git mock using builder pattern', async () => {
      ...
      mockSpawn('git log --oneline').stdout('abc123 Latest commit\ndef456 Previous commit\n').exitCode(0).mock()
    ...
    it('should mock git clone operation', async () => {
      ...
      mockSpawn('git clone https://github.com/user/repo.git').stdout('Cloning into repo...\n').exitCode(0).mock()
  ...
  describe('CommonCommands NPM Operations', () => {
    ...
    it('should mock npm test execution', async () => {
      ...
      mockSpawn('npm test').stdout('Test Suites: 5 passed, 5 total\n').exitCode(0).mock()
    ...
    it('should mock npm publish with authentication', async () => {
      ...
      mockSpawn('npm publish').stdout('+ package@1.0.0\n').exitCode(0).mock()
  ...
  describe('CommonCommands Docker Operations', () => {
    ...
    it('should mock docker build operation', async () => {
      ...
      mockSpawn('docker build -t myapp:latest .').stdout('Successfully built abc123\n').exitCode(0).mock()
    ...
    it('should mock docker run with port mapping', async () => {
      ...
      mockSpawn('docker run -p 3000:3000 myapp').stdout('Container started\n').exitCode(0).mock()
  ...
  describe('Custom Command Registration', () => {
    it('should register custom shell commands', async () => {
      ...
      mockSpawn('custom-script.sh --arg value').stdout('Custom script executed\n').exitCode(0).mock()
    ...
    it('should register Python script execution', async () => {
      ...
      mockSpawn('python3 script.py').stdout('{"result": "success"}\n').exitCode(0).mock()
    ...
    it('should register complex command arguments', async () => {
      ...
      mockSpawn('grep pattern file.txt').stdout('matched line 1\nmatched line 2\n').exitCode(0).mock()
  ...
  describe('Long-Running Process Simulation', () => {
    it('should simulate long-running build process', async () => {
      ...
      mockSpawn('npm run build').stdout('Building...\nCompiling...\nOptimizing...\nDone!\n').exitCode(0).mock()
...
[10/10] Complete!`
      ...
      mockSpawn('long-process').stdout(streamOutput).exitCode(0).mock()
  ...
  describe('Interactive Command Mocking', () => {
    ...
    it('should mock git interactive rebase', async () => {
      ...
      mockSpawn('git rebase -i HEAD~3').stdout('Successfully rebased and updated refs/heads/main.\n').exitCode(0).mock()
    ...
    it('should mock privileged package manager commands', async () => {
      ...
      mockSpawn('apt-get update').stdout('Reading package lists...\nBuilding dependency tree...\n').exitCode(0).mock()
  ...
  describe('Process Timeout Handling', () => {
    it('should handle timeout exit code', async () => {
      ...
      mockSpawn('timeout 1 sleep 10').stderr('Timeout reached\n').exitCode(124).mock()
    ...
    it('should simulate SIGTERM termination', async () => {
      ...
      mockSpawn('killed-process').stderr('Process terminated\n').exitCode(143).mock()
  ...
  describe('Additional Edge Cases', () => {
    it('should handle empty stdout', async () => {
      ...
      mockSpawn('silent-success').stdout('').exitCode(0).mock()
    ...
    it('should handle empty stderr', async () => {
      ...
      mockSpawn('clean-failure').stderr('').exitCode(1).mock()
