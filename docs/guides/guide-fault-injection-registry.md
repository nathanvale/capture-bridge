...
**Code Location:** `packages/capture/src/voice/transcriber.ts:89` *(placeholder)*
...
**Code Location:** `packages/export/src/atomic-writer.ts:67` *(placeholder)*
...
**Code Location:** `packages/capture/src/email/gmail-auth.ts:123` *(placeholder)*
...
**Code Location:** `packages/capture/src/email/gmail-poller.ts:78` *(placeholder)*
...
**Code Location:** `packages/capture/src/email/email-processor.ts:134` *(placeholder)*
...
**Code Location:** `packages/staging-ledger/src/ledger.ts:89` *(placeholder)*
...
**Code Location:** `packages/staging-ledger/src/dedup.ts:67` *(placeholder)*
...
**Code Location:** `packages/staging-ledger/src/audit.ts:45` *(placeholder)*
...
**Code Location:** `packages/export/src/atomic-writer.ts:123` *(placeholder)*
...
**Code Location:** `packages/export/src/atomic-writer.ts:145` *(placeholder)*
...
**Code Location:** `packages/export/src/atomic-writer.ts:178` *(placeholder)*
...
async function ensureIdempotent(
  ...
  if (['exported', 'exported_placeholder', 'exported_duplicate'].includes(capture.status)) {
...
*(None yet - hooks will be moved here when recovery behavior changes make them obsolete)*
